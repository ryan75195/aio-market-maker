...
namespace AIOMarketMaker.Tests.Unit.Services
{
    public class EbayScraper_UnitTests
    {
        ...
        {
            var dataDir = TestDataPaths.Listings;
        ...
        public async Task Should_return_results_in_date_range()
        {
            ...
            this._mockFetcher
                .Setup(x => x.GetPageHtmlAsync(It.IsAny<string>(), It.IsAny<IEnumerable<object>?>(), It.IsAny<string?>(), It.IsAny<TimeSpan?>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
                .ReturnsAsync(html);
