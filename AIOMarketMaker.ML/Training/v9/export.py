"""
Export the v9 RoBERTa-large variant classifier to ONNX format.
...
MODEL_DIR = Path("E:/Dev/ml-training/variant-classifier/v9/pytorch")
OUTPUT_DIR = Path("E:/Dev/ml-training/variant-classifier/v9/onnx")
...
def main():
    ...
    # Create dummy input matching v9 inference shape (512 tokens)
    dummy = tokenizer(
